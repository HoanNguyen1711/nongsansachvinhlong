          ...
          {whatsappNumber && (
            <li className="flex items-start gap-4">
              ...
              <div>
                ...
                <a href={`https://wa.me/${whatsappNumber}`} target="_blank" rel="noopener noreferrer" className="text-xs text-emerald-600 hover:text-emerald-500 hover:underline font-semibold block mt-0.5">
